...
export const services = [
  {
    ...
    faqs: [
      ...
      { q: 'What does a new layout cost?', a: 'Layout design adds $250–$500 depending on complexity (reconfiguration of existing stalls vs. full optimization) — covers planning, ADA audit, and restriping to the new configuration.' },
      { q: 'How much extra for ADA stalls?', a: 'An ADA stall with access aisle adds $75–$150 per stall over a standard stall, depending on van-accessibility and access aisle width. Includes blue symbol stenciling.' },
      { q: 'What about loading zones?', a: 'Loading zones run $200–$350 depending on size and curb treatment — typically 12–14 ft wide, double-lined in yellow, with stenciled text or symbols.' },
  ...
  },
  {
    ...
    included: [
      ...
      'Compliance audit & documentation for property records',
    ],
    faqs: [
      ...
      { q: 'What does an ADA stall cost?', a: 'An ADA stall with access aisle runs $75–$150 per stall depending on van-accessibility and access-aisle width. Includes planning, paint, and blue symbol stenciling.' },
  ...
  },
  {
    ...
    included: [‘Directional arrows’, ‘STOP bars & crosswalks’, ‘RESERVED / VISITOR / NO PARKING text’, ‘Loading zones & fire lane markings’, ‘Custom stencils & logos’],
    faqs: [
      { q: ‘How much do standard stencils cost?’, a: ‘Directional arrows run $25–$50 each; RESERVED/VISITOR text is $30–$75 per marking; ADA symbols are $50–$100. Prices vary by size and complexity.’ },
      { q: ‘What about loading zones?’, a: ‘Loading zones run $200–$350 per zone depending on size (typically 12–14 ft wide), curb color, and whether text or symbols are included.’ },
